...
<h1>Travel World</h1>			
          <ul id="nav">
			<li><a href=admin.php>Back</a></li>
			        	<li><a></a></li>
			        		<li><a href=removepack.php>Remove-Package</a></li> 
			            <li><a></a></li>
...
<?php
 $host        = "host = 127.0.0.1";
   ...
   echo"<table width=1200 height=178 align=center cellpadding=1 cellspacing=1 border=3  bordercolor= black bgcolor=>";
